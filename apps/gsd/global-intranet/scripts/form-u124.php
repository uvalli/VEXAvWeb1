...
{
	$to = 'umar-val@hotmail.co.uk';
	$subject = 'Website Change Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Name:</b></td><td>' . htmlentities($_REQUEST["custom_U153"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Changes Requested:</b></td><td>' . htmlentities($_REQUEST["custom_U142"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Website:</b></td><td>' . htmlentities($_REQUEST["custom_U163"],ENT_COMPAT,'UTF-8') . '</td></tr>';
